...
* [Flyway Migration](https://docs.spring.io/spring-boot/3.4.0-SNAPSHOT/how-to/data-initialization.html#howto.data-initialization.migration-tool.flyway)
* [JDBC API](https://docs.spring.io/spring-boot/3.4.0-SNAPSHOT/reference/data/sql.html)
* [Spring Data JPA](https://docs.spring.io/spring-boot/3.4.0-SNAPSHOT/reference/data/sql.html#data.sql.jpa-and-spring-data)
* [Spring Data Elasticsearch (Access+Driver)](https://docs.spring.io/spring-boot/3.4.0-SNAPSHOT/reference/data/nosql.html#data.nosql.elasticsearch)
* [Docker Compose Support](https://docs.spring.io/spring-boot/3.4.0-SNAPSHOT/reference/features/dev-services.html#features.dev-services.docker-compose)
